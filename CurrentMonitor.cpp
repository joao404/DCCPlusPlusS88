...
void CurrentMonitor::check(){
  current=(analogRead(pin)-offset)*CURRENT_SAMPLE_SMOOTHING+current*(1.0-CURRENT_SAMPLE_SMOOTHING);        // compute new exponentially-smoothed current
